...
export default function AttendanceTrackingWithExport() {
  ...
  const loadStudents = async (classId) => {
    ...
    try {
      ...
      // Prepare export data
      const exportableData = res.data.students.map(student => ({
        student_name: student.student_name,
        admission_number: student.admission_number,
        class_name: classes.find(c => c.class_id === classId)?.class_name || 'Unknown',
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            ...
            {selectedClass && exportData.length > 0 && (
              <button
      ...
      <ExportModal
        ...
        data={exportData}
        title={`Attendance Report - ${classes.find(c => c.class_id === selectedClass)?.class_name || 'Class'}`}
